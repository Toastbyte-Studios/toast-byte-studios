 ...
 * the portfolio sites and the studio's GitHub, and the legal and support
 * pages required by the app stores.
 *
 * @component
...
const Footer: React.FC<FooterProps> = ({ onCookieSettings }): JSX.Element => {
  ...
  return (
    <Container>
      <Info>
        {`©${currentYear} Toastbyte Studios · Las Vegas, NV · v${__APP_VERSION__}`}
      </Info>
      <Links>
        <Link
          href="https://gitall.app"
          target="_blank"
